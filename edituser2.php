<?php
    ...
    if (isset($_POST["edit"])) {
        ...
        if ($stmt->affected_rows > 0) {
            echo "<script>alert('Successfully updated dormer responsibilities!');  window.location.href = 'view_dormer.php';</script>";
        } else {
            echo "<script>alert('Failed to update dormer responsibilities!');  window.location.href = 'view_dormer.php';</script>";
        }
    }
?>
<!DOCTYPE html>
                ...
                <div class="row mb-3">
                    <div class="col-md-9">
                        <div class="input-group">
                            <input type="text" name="name" class="form-control form-control-lg bg-light fs-6" placeholder="Student Name" value="<?php echo $row["studentname"]; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
