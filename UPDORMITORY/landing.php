<?php
    ...
    require_once "../includes/landing/landing.inc.php";
?>
...
<body>
    ...
    <div class="slidebar">
        ...
        <div class="sliderBottomIcons">
            <a href="../includes/logout/logout.php"><i class="fa-solid fa-right-from-bracket"></i>Log-Out </a>
        </div>
    </div>
    ...
    <div class="custom-modal" id="dormerModal">
        <div class="custom-modal-dialog">
            <div class="custom-modal-content">
                <div class="custom-modal-header">
                    <h5 class="custom-modal-title" id="dormerModalLabel">Profile Details</h5>
    ...
    <script>
        ...
        $studentnum = isset($studentnum) ? $studentnum : 'none';
        $course = isset($course) ? $course : 'none';
        $yearlvl = isset($yearlvl) ? $yearlvl : 'none';
        $payment = isset($payment) ? $payment : 'none';
        $majoroffense = isset($major_offense) ? $major_offense : 'none';
        $minoroffense = isset($minor_offense) ? $minor_offense : 'none';
        $permit = isset($permit) ? $permit : 'none';
        ?>
        ...
        function showModal() {
            ...
            document.getElementById('permitPlaceholder').innerText ='<?php echo $permit; ?>';

            document.getElementById('dormerModal').style.display = 'flex';
        }

        
        // function showModal() {
        //     document.getElementById('namePlaceholder').innerText = name;
        //     document.getElementById('studentnumPlaceholder').innerText = studentnum;
        //     document.getElementById('coursePlaceholder').innerText = course;
        //     document.getElementById('yearLevelPlaceholder').innerText = yearLevel;
        //     document.getElementById('paymentPlaceholder').innerText = payment;
        //     document.getElementById('majoroffensePlaceholder').innerText = majoroffense;
        //     document.getElementById('minoroffensePlaceholder').innerText = minoroffense;
        //     document.getElementById('updatedPlaceholder').innerText = updated;

        //     document.getElementById('dormerModal').style.display = 'flex';
        // }

        document.querySelector('.custom-close').onclick = function() {
            document.getElementById('dormerModal').style.display = 'none';
        };
    </script>
